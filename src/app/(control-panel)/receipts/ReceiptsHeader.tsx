		...
		<div className="flex grow-0 flex-1 w-full items-center justify-between space-y-2 sm:space-y-0 py-6 sm:py-8">
			...
			>
				<div>
					...
					<Typography className="text-4xl font-extrabold leading-none tracking-tight">收款管理</Typography>
				</div>
			</motion.span>
			...
			<div className="flex flex-1 items-center justify-end space-x-2">
				...
				>
					<Button
						...
						variant="contained"
						color="secondary"
						onClick={() => navigate('/receipts/batch-create')}
						startIcon={<FuseSvgIcon>heroicons-outline:document-duplicate</FuseSvgIcon>}
